...
arrival_O <- rbind(D3_1, D3_2, D3_3, D3_4, D3_5, D3_6, arrival_O_temp)
...
theoretical_sojourn_time <- ((1/alpha)*((alpha/mu_I)/(1-(alpha/mu_I)))
                             + C*(1/(alpha))*(((0.1*(alpha/C))/mu_D1)/(1-((0.1*(alpha/C))/mu_D1)))
                             + K*(1/(alpha))*(((0.1*(alpha/C))/mu_D2)/(1-((0.1*(alpha/C))/mu_D2)))
                             + C*(1/(alpha))*(((0.1*(alpha/C))/mu_D3)/(1-((0.1*(alpha/C))/mu_D3)))
